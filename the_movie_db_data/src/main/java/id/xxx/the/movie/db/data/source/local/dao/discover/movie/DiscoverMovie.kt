package id.xxx.the.movie.db.data.source.local.dao.discover.movie

import androidx.room.Insert
import androidx.room.OnConflictStrategy
import androidx.room.Query
import androidx.room.Transaction
import id.xxx.the.movie.db.data.source.local.entity.discover.movie.DiscoverMovie
import id.xxx.the.movie.db.data.source.local.entity.discover.movie.DiscoverMovieEntity
import id.xxx.the.movie.db.data.source.local.entity.discover.movie.DiscoverMovieEntity.Companion.PAGE
import id.xxx.the.movie.db.data.source.local.entity.discover.movie.DiscoverMovieEntity.Companion.TABLE_NAME
